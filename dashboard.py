...
def carregar_dados():
    try:
        ...
        # --- CÁLCULOS DE KPIs ---
        # 1. CÁLCULO DE EMISSÕES VERIFICADAS
        ...
        # 3. CÁLCULO DO NOVO KPI "SOLICITAÇÕES UTE"
        ...
        # 4. CÁLCULO DOS FISCAIS EM ATIVIDADE
        ...
        # LINHA RETURN CORRIGIDA (com as 10 variáveis na ordem certa)
        ...
        # RETURN DE ERRO CORRIGIDO (com 10 valores para corresponder)
...
kpi_data = [
    ...
    {"label": "Frequências UTE solicitadas", "value": kpi_solicitacoes_ute, "color": "linear-gradient(to bottom, #1a3f8a, #527ac9)", "tooltip": "Total de frequências solicitadas para Uso Temporário do Espectro no evento"},
